...
public class MainGame {
    public static void main(String[] args) {
        ...
        try {
            ...
            StageConfig easyStage = new StageConfig(
                "Stage 1 - Sushi Bar (EASY)",
                240,   // durasi 3 menit
                300,       // target score 
            ...
            StageConfig hardStage = new StageConfig(
                "Stage 1 - Sushi Bar (HARD)",
                180,   // durasi 3 menit
                400,       // target score 
                3,     // max gagal beruntun
                4, // max order aktif sekaligus
                recipes
            );

            // === PILIH DIFFICULTY DI AWAL GAME ===
            ...
            if (choice == 1) {
                stageConfig = hardStage;
            } else {
                // default kalau cancel / close dialog → Easy
        ...
        GameLoop gameLoop = new GameLoop(map, kitchenLoop, orderManager, scoreManager, stageConfig);
